...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/vendor/jquery-2.0.3.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/vendor/bootstrap.js"></script>
...
<div class="page">
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
            ...
            <span class="navbar-brand">The garlic 1ho </span>
        </div>
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav navbar-left">
                <sec:authorize access="isAuthenticated()">
                    ...
                    <li><a href="${pageContext.request.contextPath}/freeboard">Freeboard</a></li>
                    <li><a href="${pageContext.request.contextPath}/humorboard">Humorboard</a></li>
            </ul>
